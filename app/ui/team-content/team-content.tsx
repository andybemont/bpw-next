      ...
      <div className="text-primary-900 h-full overflow-y-auto rounded-lg p-2">
        ...
        <h2 className="text-sm text-justify py-1 border-y-2 border-y-primary-900">
          <p>
            ...
            two photographers for most weddings, so he taught Gillian. But then
            there was another kid, and Gillian couldn't go to so many weddings -
            so her sister Carly swept in to save the day, and today shoots most
            of the weddings with Andy.
          </p>
          <p className="mt-2">
            Since then, we've taken half a million pictures of 150+ weddings at
            venues across Western New York, and only pissed off one client
            (we'll tell you all about it if you want). We love working together,
            and we'd love to bring our little team to your wedding! So check out{" "}
