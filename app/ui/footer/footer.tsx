          ...
          <div className="space-y-2">
            ...
            <address className="not-italic text-sm space-y-2">
              <div>
                ...
                >
                  <svg className="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 448 512">
              ...
              <div>
                <button
                  ...
                  onClick={() => setIsContactOpen(true)}
                >
                  <svg className="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 512 512">
