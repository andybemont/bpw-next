        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="space-y-3">
            ...
            <p className="text-sm text-primary-200">
              Wedding photography for Rochester, Buffalo, Syracuse, the Finger
              Lakes, and all of Western New York.
            </p>
              ...
              <div>
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 512 512"
                  >
                    <path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.8 90.69 226.4 209.3 245V327h-63V256h63v-54.64c0-62.2 37-96.5 93.7-96.5 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.3 482.4 504 379.8 504 256z" />
                  </svg>
                  <span>Facebook</span>
                </a>
              </div>
