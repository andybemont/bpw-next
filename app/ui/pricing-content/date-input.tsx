export default function DateInput(props: {
  ...
  return (
    <div
      className={`transition-all ease-in-out outline outline-1 outline-blue-950 rounded-xl hover:outline-2 hover:outline-white mb-2`}
    >
      <div className="font-title pl-4">
        <div className="flex flex-row">
          ...
          <div className="w-36">
            <input
              className="float-left p-0 m-1 bg-transparent text-blue-950"
              id={controlId}
              type="date"
